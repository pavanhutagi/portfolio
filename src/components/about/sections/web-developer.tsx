...
export default function WebDeveloper() {
  ...
  const languages: TechItem[] = [
    ...
    },
    {
      ...
      icon: <SiCss size={16} className="text-[#1572B6]" />,
    },
    {
      name: "JavaScript",
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M10.53 10.73c-.1-.31-.19-.61-.29-.92-.1-.31-.19-.6-.27-.89-.08-.28-.15-.54-.22-.78h-.02c-.09.43-.2.86-.34 1.29-.15.48-.3.98-.46 1.48-.14.51-.29.98-.41 1.4h2.98c-.05-.17-.13-.42-.22-.67-.1-.31-.2-.61-.3-.91h-.01l.01-.01-.01.01zm9.47-8.73h-16c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-16c0-1.1-.9-2-2-2zm-5.79 14.28c-.08.18-.2.18-.34.18h-1.67c-.17 0-.24-.06-.28-.18l-.64-1.92h-3.36l-.57 1.88c-.04.14-.14.22-.3.22h-1.54c-.17 0-.2-.08-.16-.24l3.03-8.84c.04-.14.04-.24.06-.44h2.28c.1 0 .17.08.19.2l3.37 9.08c.06.16.02.24-.08.26zm5.79-1.78c0 .12-.08.2-.2.2h-1.64c-.14 0-.22-.08-.22-.2v-5.6c0-.12.08-.2.22-.2h1.64c.12 0 .2.08.2.2v5.6zm-.06-7.12c-.58.56-1.42.56-2 0-.28-.28-.42-.62-.42-1.02 0-.42.14-.76.42-1.04.58-.56 1.42-.56 2 0 .28.28.42.62.42 1.04 0 .42-.14.76-.42 1.02z" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M9.85 8.42c-.37-.15-.77-.21-1.18-.2-.26 0-.49 0-.68.01-.2.01-.34.02-.41.03v3.36c.11.01.25.02.43.02h.52c.42.01.83-.08 1.21-.26.34-.16.61-.42.8-.74.19-.33.28-.72.28-1.15 0-.42-.09-.79-.28-1.07-.2-.3-.43-.5-.69-.6v.6zm10.15-6.42h-16c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-16c0-1.1-.9-2-2-2zm-9.01 12.08c-.51.31-1.11.49-1.68.49-.13 0-.25 0-.36-.01-.11 0-.22-.02-.31-.03v3.46c0 .12-.06.18-.18.18h-1.64c-.12 0-.18-.06-.18-.18v-9.42c0-.11.04-.16.12-.16.33-.06.74-.12 1.18-.16.44-.04.86-.06 1.28-.06.69 0 1.28.11 1.78.34.47.21.87.55 1.14.98.27.42.41.92.41 1.5 0 .59-.15 1.12-.44 1.58-.31.49-.73.86-1.24 1.12l.12-.63zm7.01 1.09c0 .12-.06.18-.18.18h-1.64c-.12 0-.18-.06-.18-.18v-3.26c0-.7-.12-1.22-.35-1.56-.23-.34-.58-.52-1.05-.52-.32 0-.62.1-.88.29-.26.19-.44.44-.55.75-.06.17-.09.38-.09.62v3.68c0 .12-.06.18-.18.18h-1.64c-.12 0-.18-.06-.18-.18v-5.6c0-.31-.01-.65-.03-.99-.02-.34-.04-.63-.06-.87 0-.08.04-.14.12-.16l1.52-.12c.12 0 .18.06.2.16l.1.88h.04c.24-.36.56-.64.93-.84.39-.22.82-.32 1.3-.32.73 0 1.3.24 1.72.72.42.48.63 1.18.63 2.12v4.92h-.01z" />
        </svg>
      ),
    },
  ];
